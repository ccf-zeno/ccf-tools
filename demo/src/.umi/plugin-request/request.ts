// @ts-nocheck
/**
 * Base on https://github.com/umijs/C:/USE/code3/ccf-all-tools/demo/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from 'C:/USE/code3/ccf-all-tools/demo/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from 'C:/USE/code3/ccf-all-tools/demo/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from 'C:/USE/code3/ccf-all-tools/demo/node_modules/@ahooksjs/use-request/lib/types';
